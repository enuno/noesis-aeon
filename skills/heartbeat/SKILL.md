...
|-------|----------|--------|-------------:|---------------------:|
| token-movers | 2026-04-24 12:30 UTC | ✅ success | 100% | 0 |
...
- Never expose values from `.env`, secrets, or anything outside cron-state.json + issues/INDEX.md + aeon.yml. This file is public.
